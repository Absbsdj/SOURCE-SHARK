...
async def anem_1(c, msg):
    ...
    animation_chars = [
        ...
        "😡",
        "😢",
        "__**[قناه تنصيب حسابات تيليثون - ✅]**__(https://t.me/X_YI1I)",
    ]
    for i in animation_ttl:
        await asyncio.sleep(animation_interval)
        await msg.edit(animation_chars[i % 10])
...
@Client.on_message(filters.command(["shark", "سورس القرش", "السورس"], ".") & filters.me)
async def gajjajay(client: Client, message: Message):
    ...
    await message.edit("🔥🔥🔥")
    await asyncio.sleep(0.3)
    await message.edit("سورس القرش هيعمل عظمه 🥹❤️")
...
async def hak(client: Client, message: Message):
  ...
  asyncio.sleep(2)
  await message.edit_text("۞︙  تـم اخـتراق الضـحية..\n\nقـم بالـدفع الى سورس القرش لعـدم نشـر معلوماتك وصـورك")
